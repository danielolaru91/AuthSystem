...
@Component({
  ...
  imports: [Field, MatFormFieldModule, MatInputModule, MatCardModule, MatButtonModule, MatSnackBarModule, MatProgressSpinnerModule],
  ...
  template: `
    <div class="register-wrapper">
        <mat-card>
            ...
            <mat-card-footer>
                <button matButton="filled" [disabled]="registerForm().invalid() || loading()" (click)="onSubmit($event)">
                    @if(loading()){
